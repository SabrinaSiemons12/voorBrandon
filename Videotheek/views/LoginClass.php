	...
	class LoginClass
	{
		...
		*/
		...
		private static function send_email($emailadres, $post, $wachtwoord)
		{
			...
			$message .= "klik <a href='localhost/Project/index.php?content=activate&email=".$emailadres."&emailadres=".$post['emailadres']."&wachtwoord=".$wachtwoord."'>hier</a> om uw account te activeren"."<br>";
